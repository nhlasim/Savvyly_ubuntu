...
from core import views, transfer, transaction, payment_request, loan # credit_card
...
urlpatterns = [
    ...
    # Credit Card URLS
    # path("loan/<loan_id>/", loan.loan_detail, name="card-detail"),
    # <a href="{% url 'core:loan-detail' loan.loan_id %}">
    path("loan/<loan_id>/", loan.loan_detail, name="loan-detail"),
    path("repay-loan/<loan_id>/", loan.repay_loan, name="repay-loan"),
    # path("fund-credit-card/<loan_id>/", loan.repay_loan, name="fund-credit-card"),
    # path("withdraw_fund/<loan_id>/", credit_card.withdraw_fund, name="withdraw_fund"),
    # path("delete_card/<loan_id>/", credit_card.delete_card, name="delete_card"),
